...
redRectangle = RectangleAsset(150,25,blackOutline,red) #width, height, outline, fill
blackRectangle = RectangleAsset(150,25,blackOutline,black)
yellowRectangle = RectangleAsset(150,25,blackOutline,yellow)
